...
public class PolicyImprovement {
	...
	/**
	 * It constructs on object to solve a general stochastic optoimal control problem in continuous time, with one-dimensional domain for the controlled process.
